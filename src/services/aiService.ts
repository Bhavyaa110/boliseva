  ...
  static generateResponse(userInput: string, language: string): string {
    const responses = {
      ...
      hi: {
        ...
        emiHelp: "ईएमआई का मतलब है समान मासिक किस्त - यह वह निश्चित राशि है जो आप हर महीने अपना ऋण चुकाने के लिए देते हैं। इसे किराए की तरह समझें, लेकिन अपने ऋण के लिए।\n\nमैं आपकी मदद कर सकता हूं:\n• देखना कि अगला भुगतान कब है\n• UPI या बैंक ट्रांसफर से ईएमआई भरना\n• अपने आप याद दिलाने का इंतज़ाम\n• अलग-अलग ऋण राशि के लिए ईएमआई की गणना\n• समझना कि भुगतान छूटने पर क्या होता है\n\nईएमआई में कौन सी मदद चाहिए?",
